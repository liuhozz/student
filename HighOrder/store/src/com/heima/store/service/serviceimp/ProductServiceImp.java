...
public class ProductServiceImp implements ProductService {
	...
	@Override
	public PageModel findAll(int currnum) throws SQLException {
		// TODO Auto-generated method stub
		ProductDao dao=new ProductDaoImp();
		int totalRecords=dao.findcount(currnum);
		PageModel page=new PageModel(currnum, totalRecords, 12);
		List<Product> list = dao.findAll(page.getStartIndex(), page.getPageSize());
