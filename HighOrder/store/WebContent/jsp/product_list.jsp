...
<html>
	...
	<body>
		...
		<c:forEach items="${page.list }" var="pro">
			...
			<div class="col-md-2">
				<a href="${pageContext.request.contextPath}/IndexServlet?method=pro_info&pid=${pro.pid}">
					<img src="${pageContext.request.contextPath}/${pro.pimage}" width="170" height="170" style="display: inline-block;">
				</a>
				<p><a href="${pageContext.request.contextPath}/IndexServlet?method=pro_info&pid=${pro.pid}" style='color:green'>${pro.pname }</a></p>
		...
		<!--分页 
		ProductServlet?method=prolist&num=1&cid=
		-->
