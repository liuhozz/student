...
<!--head begin-->
		<div class="z_head">
			...
			<img src="ImgVedio/image/LOGO.png"></img>
				&#160;
			<img src="ImgVedio/image/logo_1.jpg"></img>
				<img src="ImgVedio/image/logo_2.jpg"></img>
			...
			<div class="z_navcon">
				<div class="jqueryslidemenu" id="myslidemenu">
					<ul>
						...
						<li>
							<a href="jsp/hosManage/manageIndex.jsp" title="科室简介">科室简介</a>
							<ul>
								<li>
						...
						<li>
							<a href="jsp/hosServe/index.jsp" title="特色疗法">特色疗法</a>
							<ul>
								<li>
						...
						<li>
							<a href="jsp/Employmentguide/index.jsp" title="科室简介">研究所介绍</a>
						</li>
						<li>
							<a href="jsp/nursing/index.jsp" title="专家风采">专家风采</a>
							<ul>
								<li>
						...
						<li>
							<a href="partyGroup/index.jsp" title="党建群团">党建群团</a>
							<ul>
								<li>
						...
						<li>
							<a href="jsp/hosCulture/index.jsp" title="公告通知">公告通知</a>
							<ul>
								<li>
