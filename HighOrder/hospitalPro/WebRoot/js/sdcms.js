...
{	
	var winname=window.open('about:blank', '_blank', 'top=100');
		...
		winname.document.execCommand('saveas','','http://www.xy3yy.com/itc/skins/2009/js/runcode.htm');
		winname.close();		
}
...
{  
	...
	{
		$('#showmsg').html(t0.substring(1));
		if(t0.substring(0,1)==0){theform.username.value='';theform.content.value='';;$('#showmsg').html("<img src="+webdir+"skins/2009/images/loading.gif>发布成功");setTimeout("window.location.href='sdcms.js-'/*tpa=http://www.xy3yy.com/itc/skins/2009/js/sdcms.js?*/;","3000");}
		}
	});
	return false
}
...
{  
	...
	success:function(_)
	{
		...
		if(_.substring(0,1)==1)
		{
			...
			setTimeout("window.location.href='sdcms.js-'/*tpa=http://www.xy3yy.com/itc/skins/2009/js/sdcms.js?*/;","3000");
			}
		}
	});
	return false
...
{  
	...
	success:function(t0)
	{
		...
		if(t0.substring(0,1)==0){$('#showvote').html(t0.substring(1));if(t1==1){window.location.href='sdcms.js-id='/*tpa=http://www.xy3yy.com/itc/skins/2009/js/sdcms.js?id=*/+theform.vote_id.value+'';}}
		}
	});
	return false
}
