				...
				<div style="margin:0 auto;margin-top:10px;width:950px;">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<c:forEach items="${order.list}" var="lo">
								<tr class="active">
									<td width="60" width="40%">
										<input type="hidden" name="id" value="22">
										<img src="${pageContext.request.contextPath}/${lo.product.pimage}" width="70" height="60">
									</td>
									<td width="30%">
										<a target="_blank"> ${lo.product.pname}</a>
									</td>
									<td width="20%">
										￥${lo.product.shop_price}
									</td>
									<td width="10%">
										${lo.quantity}
									</td>
									<td width="15%">
										<span class="subtotal">￥${lo.total}</span>
									</td>
								</tr>
							</c:forEach>
						</tbody>
