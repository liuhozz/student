...
<body>
    <div class="header">
        ...
        <ul class="inline">
            <li>
                <img src="${pageContext.request.contextPath}/images/32/client.png" />&nbsp;&nbsp;欢迎您,${loginUser.username}
            </li>
            <li class="dropdown">
    ...
    <div class="container-fluid content">
        <div class="row-fluid">
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">
                                <img class="left-icon" src="${pageContext.request.contextPath}/images/32/5026_settings.png" /><span class="left-title">系统设置</span>
                            </a>
                        </div>
                        ...
                        <div id="collapseOne" class="accordion-body collapse in">
                            <div class="accordion-inner">
                                <img class="left-icon-child" src="${pageContext.request.contextPath}/images/32/4957_customers.png" /><span class="left-body">客户管理</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="span10 content-right">
                <iframe src="${pageContext.request.contextPath}/custList.action" class="iframe"></iframe>
            </div>
        </div>
    </div>
