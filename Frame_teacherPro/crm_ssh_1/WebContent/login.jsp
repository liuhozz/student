...
function regist(){
	window.location="user_registUI.action";
...
<BODY>
	<FORM id=form1 name=form1 action="user_login.action" method=post>
											...
											<TD>
												<TABLE cellSpacing=0 cellPadding=2 border=0>
													<TBODY>
														...
														<TR>
															<TD>
																<input type="button" onclick="regist()" value="regist" style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px"/>
															</TD>
															<TD><INPUT id=btn
