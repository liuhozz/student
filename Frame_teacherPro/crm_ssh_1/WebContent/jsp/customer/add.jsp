...
<script type="text/javascript">
	$(function(){
		$.post("daseDict_findDict.action",{"dict_type_code":"001"},function(data){
			console.log(data);
		...
		$.post("daseDict_findDict.action",{"dict_type_code":"002"},function(data){
			$(data).each(function(i,obj){
		...
		$.post("daseDict_findDict.action",{"dict_type_code":"006"},function(data){
			$(data).each(function(i,obj){
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<!-- <INPUT class=textbox id=sChannel2
								 	  ...
								 	  <select id="customerLevel" name="daseDictLevel.dict_id">
							...
							<TR>
								...
								<!-- <INPUT class=textbox id=sChannel2
									...
									<select id="customerSource" name="daseDictSource.dict_id">
								 	  	<option value="">--请选择--</option>
								 	  </select>
								</td>
								<td>所属行业 ：</td>
								...
								<!-- <INPUT class=textbox id=sChannel2
														style="WIDTH: 180px" maxLength=50 name="custSource"> -->
									<select id="customerIndustry" name="daseDictIndustry.dict_id">
								 	  	<option value="">--请选择--</option>
								 	  </select>
								</td>
							</TR>
