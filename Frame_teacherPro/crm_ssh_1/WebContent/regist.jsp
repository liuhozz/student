...
<BODY>
	<FORM id=form1 name=form1 action="user_regist.action" method=post>
			...
			<DIV>
				<TABLE cellSpacing=0 cellPadding=0 width=900 align=center border=0>
					<TBODY>
						...
						<TR>
							<TD background=images2/regist_bt.png height=300>
												...
												<TABLE cellSpacing=0 cellPadding=2 border=0>
													<TBODY>
														...
														<TR>
															...
															<TD style="HEIGHT: 28px"><SPAN
																id=RequiredFieldValidator4
																style="FONT-WEIGHT: bold; VISIBILITY: hidden; COLOR: white">请姓名</SPAN></TD>
														</TR>
														<TR>
														...
														<TR>
															...
															<TD><INPUT id=btn
																...
																type=image src="images2/regist_button.gif" name=btn>
															</TD>
