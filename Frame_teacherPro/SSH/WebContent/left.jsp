...
<div class="header">
    ...
    <ul class="inline">
        <li>
            <img src="${pageContext.request.contextPath}/images/32/client.png"/>&nbsp;&nbsp;欢迎您,<s:property value="#user.nickname"/> <font
...
<div class="container-fluid content">
    <div class="row-fluid">
        ...
        <div class="span10 content-right">
            ...
            <iframe src="${pageContext.request.contextPath}/customer_findAll.action" class="iframe" name="iframe"></iframe>
        </div>
    </div>
</div>
