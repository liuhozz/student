...
<html>
<head>
    <title>客户关系用户登录页面</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <script type="text/javascript" src="${pageContext.request.contextPath}/scripts/jquery-1.9.1.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/scripts/login.js"></script>
    <link href="${pageContext.request.contextPath}/styles/login2.css" rel="stylesheet" type="text/css"/>
</head>
<body>
<h1>客户关系用户登录<sup>2016</sup></h1>
...
<div class="login" style="margin-top:50px;">
    ...
    <div class="header">
        <div class="switch" id="switch"><a class="switch_btn_focus" id="switch_qlogin" href="javascript:void(0);"
            ...
            <font color="red"><s:property value="#umessage"/> </font>
            <font color="red"><s:property value="#pmessage"/> </font>
        ...
        <div class="web_login" id="web_login">
            ...
            <div class="login-box">
                ...
                <div class="login_form">
                    ...
                    <form action="${pageContext.request.contextPath}/user_login.action" name="loginform"
                          accept-charset="utf-8" id="login_form" class="loginForm" method="post"><input type="hidden"
                                                                                                        name="did"
                                                                                                        value="0"/>
