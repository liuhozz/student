										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/customer_findcustByid.action?cust_id=<s:property value="cust_id "/>">修改</a><!-- &custId=<s:property value="cust_id "/> -->
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/customer_del.action?cust_id=<s:property value="cust_id "/>">删除</a><!-- &custId=<s:property value="cust_id "/> -->
													</TD>
												</TR>
